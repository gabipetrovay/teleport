...
const cfg = {
  ...
  api: {
    ...
    unifiedResourcesPath:
      '/v1/webapi/sites/:clusterId/resources?searchAsRoles=:searchAsRoles?&limit=:limit?&startKey=:startKey?&pinnedResourcesIDs=:pinnedResourcesIDs?&kinds=:kinds?&query=:query?&search=:search?&sort=:sort?',
    nodesPath:
