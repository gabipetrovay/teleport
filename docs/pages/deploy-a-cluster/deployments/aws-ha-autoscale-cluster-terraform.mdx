...
(OSS users can provide any valid local file path here - it isn't used by the Teleport Auth Service in a Teleport OSS install)
...
To manually join Teleport agents to your cluster, you will need [a node join token](../../agents/join-services-to-your-cluster/join-token.mdx).
...
to a Teleport Auth Service instance. Follow the instructions in our [Trusted Clusters guide](../../management/admin/trustedclusters.mdx).
