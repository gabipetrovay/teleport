...
import { resourceKey, resourceName, HoverTooltip } from './Resources';
    ...
    >
      <CardOuterContainer showAllLabels={showAllLabels}>
        ...
        >
          ...
          />
          <PinButton setPinned={setPinned} hovered={hovered} pinned={pinned} />
...
function PinButton({
  ...
  return (
    <HoverTooltip tipContent={<>{pinned ? 'Unpin' : 'Pin'}</>}>
      <ButtonIcon
        css={`
