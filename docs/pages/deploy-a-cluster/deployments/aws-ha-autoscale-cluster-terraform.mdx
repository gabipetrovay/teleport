...
(OSS users can run `touch /tmp/license.pem` locally to create an empty file, and then provide the path '/tmp/license.pem'
here. The license file isn't used in a Teleport OSS install)
